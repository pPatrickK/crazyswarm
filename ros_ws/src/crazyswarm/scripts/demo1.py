...
if __name__ == "__main__":
    ...
    for i in range(TRIALS):
        ...
        allcfs.startTrajectory(0, TIMESCALE * 0.85, groupMask=0b00000001)
        allcfs.startTrajectory(0, TIMESCALE, groupMask=0b00000010)
        allcfs.startTrajectory(0, TIMESCALE * 0.65, groupMask=0b00000100)
        allcfs.startTrajectory(0, TIMESCALE * 1.3, groupMask=0b00001000)
        timeHelper.sleep(traj2.duration * TIMESCALE + 2)
...
################################################################################
        ...
        # timeHelper.sleep(5.5)
################################################################################
        allcfs.startTrajectory(0, TIMESCALE * 0.85, groupMask=0b00000001, reverse=True)
        allcfs.startTrajectory(0, TIMESCALE, groupMask=0b00000010, reverse=True)
        allcfs.startTrajectory(0, TIMESCALE * 0.65, groupMask=0b00000100, reverse=True)
